...
tournement_last_modification_date timestamp NOT NULL,
tournement_start_date timestamp NOT NULL,
tournement_end_date timestamp NOT NULL,
tournement_entrance_fee	decimal NOT NULL,
